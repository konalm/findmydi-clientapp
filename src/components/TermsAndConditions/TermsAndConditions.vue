...
<div>
  <app-header />
  <page-header :header="'Terms and conditions of use'" />

  <div class="container">

  <h2>Introduction</h2>

  <p>These terms and conditions apply between you, the User of this Website 
    (including any sub-domains, unless expressly excluded by their own terms and conditions), 
    and Find My Driving Instructor, the owner and operator of this Website. Please read 
    these terms and conditions carefully, as they affect your legal rights. Your agreement 
  ...
  <p>In these terms and conditions, <strong>User</strong> or <strong>Users</strong> means 
    any third party that accesses the Website and is not either (i) employed by Find My 
    Driving Instructor and acting in the course of their employment or (ii) engaged as 
    a consultant or otherwise providing services to Find My Driving Instructor and 
    accessing the Website in connection with the provision of such services.
  </p>

  <p>You must be at least 18 years of age to use this Website. By using the Website 
    and agreeing to these terms and conditions, you represent and warrant that you are 
  ...
  <ol>
    <li>All Content included on the Website, unless uploaded by Users, is the property 
      of Find My Driving Instructor, our affiliates or other relevant third parties. 
      In these terms and conditions, Content means any text, graphics, images, audio, 
      ...
      logo or service mark displayed on the site without the owner's prior written 
      permission
    </li>
...
<li>You must not otherwise reproduce, modify, copy, distribute or use for commercial 
    purposes any Content without the written permission of Find My Driving Instructor.
</li>
</ol>
...
<li>You may not use the Website for any of the following purposes:
  <ol>
    <li>in any way which causes, or may cause, damage to the Website or interferes with 
      any other person's use or enjoyment of the Website;
    </li>

    <li>in any way which is harmful, unlawful, illegal, abusive, harassing, threatening 
      or otherwise objectionable or in breach of any applicable law, regulation, 
      governmental order;
    </li>
...
<ol>
  ...
  <li>You must inform us immediately of any changes to the information that you provide 
    when registering by updating your personal details to ensure we can communicate 
    with you effectively.
  </li>

  <li>We may suspend or cancel your registration with immediate effect for any reasonable 
    purposes or if you breach these terms and conditions.
  </li>

  <li>You may cancel your registration at any time by informing us in writing to the 
...
<ol>
  <li>This Website may contain links to other sites. Unless expressly stated, these 
    sites are not under the control of Find My Driving Instructor or that of our 
    affiliates.
  </li>

<li>We assume no responsibility for the content of such Websites and disclaim liability 
...
<ol>
<li>Use of the Website is also governed by our Privacy Policy, which is incorporated into these terms and conditions by this reference. To view the Privacy Policy, please click on the following: <a href="/privacy-policy">findmydi.com/privacy-policy.</a></li>
</ol>
<h2>Availability of the Website and disclaimers</h2>
<ol>
<li>Any online facilities, tools, services or information that Find My Driving Instructor makes available through the Website (the <strong>Service</strong>) is provided "as is" and on an "as available" basis. We give no warranty that the Service will be free of defects and/or faults. To the maximum extent permitted by the law, we provide no warranties (express or implied) of fitness for a particular purpose, accuracy of information, compatibility and satisfactory quality. FInd My Driving Instructor is under no obligation to update information on the Website.</li>
<li>Whilst FInd My Driving Instructor uses reasonable endeavours to ensure that the Website is secure and free of errors, viruses and other malware, we give no warranty or guaranty in that regard and all Users take responsibility for their own security, that of their personal details and their computers.</li>
<li>FInd My Driving Instructor accepts no liability for any disruption or non-availability of the Website.</li>
<li>FInd My Driving Instructor reserves the right to alter, suspend or discontinue any part (or the whole of) the Website including, but not limited to, any products and/or services available. These terms and conditions shall continue to apply to any modified version of the Website unless it is expressly stated otherwise.</li>
</ol>
...
<li>To the maximum extent permitted by law, FInd My Driving Instructor accepts no liability for any of the following:
<ol>
...
<h2>Find My Driving Instructor details</h2>
<ol>
<li>Find My Driving Instructor is a company incorporated in England and Wales with registered number 42 whose registered address is aberdeen street, west midlands, b187dw and it operates the Website findmydi.com.
<p>You can contact FInd My Driving Instructor by email on hello@findmydi.com.</p>
</li>
</ol>
</div>
...
import AppHeader from '@/components/patterns/user-header'
import AppFooter from '@/components/patterns/Footer.vue'
import PageHeader from '@/components/patterns/PageHeader.vue'

@Component({
 components: {
    AppHeader, PageHeader, AppFooter
  }
})
